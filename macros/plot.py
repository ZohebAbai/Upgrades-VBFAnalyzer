...
def signalEff():
  ...
  hframe.GetXaxis().SetBinLabel(3 ,"p_{T}") ; 
  ...
  for m in masses:
    for pu in pus:
      f = ROOT.TFile.Open('VBF_M125_PU0.root', 'read')
      h = f.Get('h_cutflow')
      h_cutflow = copy.deepcopy(h.Clone('h_cutflow_M125_PU0.root' ))
...
def plotStacked(hists, pu, xtitle, ytitle, xlow, xhigh, rebin, logy):
  ...
  for m in msigs:
    ...
    fsig = ROOT.TFile.Open('/afs/cern.ch/work/z/zabai/VBF_H/fulsimcrab_10k/CMSSW_9_3_7/src/Upgrades/VBFAnalyzer/macros/VBF_M125_PU0.root')
    hs = ROOT.TH1D()
    for h in histnames:
...
#  h_mjj_data_obs.Write()
  ...
  print "Nsig = %f" % hsig.Integral()

  fout.Close()

#signalEff()

plotStacked('h_sdmass_ak80'                ,     0, 'soft drop m_{JJ} [GeV]', 'Events', 0., 200., 4, 1)
plotStacked('h_mjj'                        ,   0, 'mass of AK8 jets [GeV]', 'Events', 0., 200., 4, 1)
#plotStacked('h_nak8'                      ,   0, 'AK8 jet multiplicity', 'Events', 0., 20, 1, 1)
#plotStacked('h_nak4'                      ,   0, 'AK4 jet multiplicity', 'Events', 0., 20, 1, 1)
plotStacked('h_ak80pt'                     ,   0, 'p_{T} of leading A8 jet [GeV]', 'Events', 0., 1000., 10, 1)
plotStacked('h_ak80eta'                    ,   0, '#eta leading A8 jet', 'Events', -5., 5., 10, 1)
plotStacked('h_ak40pt'                     ,   0, 'p_{T} ak4_1 jet [GeV]', 'Events', 0.,1000., 4,1)
plotStacked('h_ak41pt'                     ,   0,  'p_{T} ak4_2 jet [GeV]', 'Events', 0.,1000., 4,1)
plotStacked('h_ak40eta'                    ,   0, '#eta ak4_1 jet', 'Events', -5., 5., 8, 1)
plotStacked('h_ak41eta'                    ,   0, '#eta ak4_2 jet', 'Events', -5., 5., 8, 1)
plotStacked('h_ak4_deepcsv1'               ,   0, 'DeepCSV of AK4_1 ', 'Events', 0., 1., 4, 1)
plotStacked('h_ak4_deepcsv2'               ,   0, 'DeepCSV of AK4_2', 'Events', 0., 1., 4, 1)

plotStacked('h_sj0_pts'                     ,   0, 'p_{T} ak4_subjet1 jet [GeV]', 'Events', 0.,1000., 4,1)
plotStacked('h_sj1_pts'                     ,   0, 'p_{T} ak4_subjet2 jet [GeV]', 'Events', 0.,1000., 4,1)
plotStacked('h_sj0_etas'                    ,   0, '#eta ak4_subjet1 jet', 'Events', -5., 5., 8, 1)
plotStacked('h_sj1_etas'                    ,   0, '#eta ak4_subjet2', 'Events', -5., 5., 8, 1)
plotStacked('h_sj0_deepcsv'               ,   0, 'DeepCSV of AK4_subjet1 ', 'Events', 0., 1., 4, 1)
plotStacked('h_sj1_deepcsv'               ,   0, 'DeepCSV of AK4_subjet2 ', 'Events', 0., 1., 4, 1)
plotStacked('h_higgs_invariantMassb'      ,   0, 'm_higgs_invariant_b [GeV]', 'Events', 0., 200., 4, 1)
plotStacked('h_higgs_invariantMassbb'      ,   0, 'm_higgs_invariant_bb [GeV]', 'Events', 0., 200., 4, 1)
